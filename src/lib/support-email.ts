...
export function supportEmailTemplate(input: SupportEmail): string {
	return `
                                  ...
                                  <tbody>
                                    <tr>
                                      <td>
                                        ...
                                        <p style="font-size:16px;color:rgb(55,65,81);margin-bottom:8px;margin-top:0px;line-height:24px">
                                          Selected: <span style="color:#cc0000;font-weight:700;text-transform:uppercase;">${input.supporttype}</span>
                                        </p>
                                      </td>
                                    </tr>
                                  </tbody>
                            ...
                            <tr>
                              <td>
                                <p style="font-size:12px;color:rgb(75,85,99);text-align:center;margin:0px;line-height:24px;margin-top:0px;margin-bottom:0px;margin-left:0px;margin-right:0px">
                                  This email was generated by and sent from cobaltweb.tech website support form.
                                </p>
                              </td>
                            </tr>
                          </tbody>
