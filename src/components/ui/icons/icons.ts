...
export const Icons = {
  ...
  arrowDown: {
    ...
    class: "h-6 w-6 rotate-180 flex-shrink-0 text-orange-400 dark:text-orange-300",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  arrowRightCircle: {
    ...
    class: "h-6 w-6 flex-shrink-0 text-slate-50 transition duration-300 group-hover:translate-x-1",
    width: 24,
    height: 24,
    viewBox: "0 0 32 32",
    fillRule: "evenodd",
  ...
  question: {
    ...
    class:
      "mt-1.5 h-6 w-6 flex-shrink-0 text-slate-600 dark:text-slate-400",
    viewBox: "0 0 24 24",
    fill: "none",
    strokeWidth: "1.5",
    strokeLinecap: "round",
  ...
  envelopeOpen: {
    ...
    class:
      "mt-1.5 h-6 w-6 flex-shrink-0 text-slate-600 dark:text-slate-50",
    viewBox: "0 0 24 24",
    fill: "none",
    strokeWidth: "1.5",
    strokeLinecap: "round",
  ...
  messageSend: {
    ...
    class: "h-6 w-6 flex-shrink-0 transition duration-300 group-hover:translate-x-1",
    viewBox: "0 0 14 14",
    fill: "currentColor",
  },
  earth: {
  ...
  clock: {
    ...
    class: "h-6 w-6 text-slate-600 dark:text-slate-50 flex-shrink-0 transition duration-300 group-hover:translate-x-1",
    viewBox: "0 0 512 512",
    fill: "currentColor",
  },
  phone: {
  ...
  lightning: {
    ...
    class: "mt-1 h-10 w-10 sm:h-16 sm:w-16 flex-shrink-0 fill-orange-400 dark:fill-orange-300",
    width: 48,
    height: 48,
    viewBox: "0 0 48 48",
  },
